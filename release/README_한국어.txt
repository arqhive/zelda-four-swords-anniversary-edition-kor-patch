==============================================================
 젤다의 전설 4개의 검 25주년 에디션 (북미판 DSiWare) 한글 패치 v1.1
 The Legend of Zelda: Four Swords Anniversary Edition - Korean Patch
==============================================================

제작: arqhive
배포 파일: Zelda_4Swords_AE_KQ9E_Korean_v1.1.bps
...
- 게임 제목 로고: 젤다의 전설 / 4개의 검 / 25주년 에디션
- 파일 복사·삭제 확인 안내, 뒤로·나가기·대기 표시, 친구 모집·그룹 메뉴 한글화
- 수련장 지도 이름판에 남아 있던 영문 글자 조각 제거
- v1.1 그래픽은 사용자 에뮬레이터 실행 확인, 로고 수정본은 사용자 실기 표시 확인 완료
- v1.1 배포 파일 갱신: 큰 제목 로고의 영문 잔여 문제 수정
  이전 v1.1을 받았다면 다시 내려받아 북미판 원본에 적용하세요. 버전은 v1.1 유지.
...
■ 패치 적용 방법
--------------------------------------------------------------
이 패치는 원본에 적용하는 누적 패치입니다. 이전 한글 패치본에 덧씌우지 마세요.

[Rom Patcher JS]
  1. 사이트 접속
  2. "ROM file"에 원본 파일 선택
  3. "Patch file"에 Zelda_4Swords_AE_KQ9E_Korean_v1.1.bps 선택
...
적용 후 파일 확인값:
   - 크기 : 14,496,768 바이트
   - CRC32: DC17C0D2
   - MD5  : 20dc955b33ff48120f13bc221d86a396
   - SHA1 : 9ccbaed11f2b045655e5cb2b23c1622a77b099cc
...
■ 실행 방법
--------------------------------------------------------------
[3DS / DSi 실기 - TWiLight Menu++ (이전 버전에서 확인)]
...
- 모든 해금 상태·멀티플레이 화면을 전수 검증한 것은 아닙니다.
...
■ 버전 기록
--------------------------------------------------------------
v1.1    제목 로고와 추가 UI 그래픽 한글화, 수련장 이름판 잔여 픽셀 수정
        (대사·폰트는 v1.0.1 그대로 유지)
        동일 버전 재배포: 실제 표시용 로고 두 사본 누락 수정, 사용자 실기 확인 완료
