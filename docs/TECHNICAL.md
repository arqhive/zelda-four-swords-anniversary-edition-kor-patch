...
- 로고 제작 프롬프트는 [`TITLE_LOGO_PROMPT.txt`](TITLE_LOGO_PROMPT.txt), 제작 이미지 SHA256은 `3a2dd3573c5e23b04b7cbedf548e9e8af6958410dd38755d121bebedab86c5e4`이다. 제작 이미지는 게임 그래픽을 포함하므로 저장소에 넣지 않는다. 일반 빌드는 확정된 `patches/gfx/subtask.cmp.bps`를 사용한다.
